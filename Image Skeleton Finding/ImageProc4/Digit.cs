...
namespace ImageProc4
{
    public class Digit
    {
        ...
        public Digit(int d, int center, int centerv)
        {
            ...
            g.DrawString(d.ToString(), Form1.myFont, Brushes.Black, new RectangleF(-MATRIX_SIZE / 6 + center, -MATRIX_SIZE / 10 + centerv, MATRIX_SIZE + MATRIX_SIZE / 5, MATRIX_SIZE + MATRIX_SIZE / 2));
            btp = (Bitmap)mydigit;
            Color pixelColor;
